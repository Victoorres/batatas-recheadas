    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-center mb-6 incandescent-title">
            ...
            {showcaseImages.map((image, index) => (
              ...
              >
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-2 incandescent-subtitle">
                    {image.title}
                  </h3>
                </div>
              </div>
            ...
            {showcaseImages.map((_, index) => (
              <button
                ...
                className={`w-5 h-5 sm:w-6 sm:h-6 rounded-full transition-all duration-300 ${
                  index === currentImage
                    ? 'bg-[#daa821] shadow-lg shadow-[#daa821]/50 scale-125 drop-shadow-[0_0_20px_rgba(218,168,33,1)]'
